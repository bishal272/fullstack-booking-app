        ...
        <div className="">
          <form action="">
            ...
            <p className="text-gray-500 text-sm">
              Title for your place should be something catchy for the
              advertisement
            </p>
            ...
            <p className="text-gray-500 text-sm">Location of your place</p>
            <input type="text" className="" placeholder="Address" />
            <h2 className="text-2xl mt-4">Photos</h2>
            <p className="text-gray-500 text-sm">More the Merrier</p>
            <div className="flex gap-2">
              <input type="text" placeholder="Add a link to the ...jpeg" />
            ...
            <p className="text-gray-500 text-sm">
              Say good things about your place
            </p>
            <textarea />
            <h2 className="text-2xl mt-4">Perks</h2>
            <p className="text-gray-500 text-sm">
              Select the features your place provides
            </p>
            ...
            <p className="text-gray-500 text-sm">
              Add the check in and check out time, remember to add some between
              guests for cleaning..
            </p>
